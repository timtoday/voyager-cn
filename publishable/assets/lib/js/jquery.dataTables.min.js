...
(function(h) {
                ...
                if ("" !== f) {
                    ...
                    for (var i = 0, o = j.length; i < o; i++) {
                        ...
                        if (f) {
                            ...
                            j =
                                j.join(".");
                            if (h.isArray(a)) { i = 0; for (o = a.length; i < o; i++) g.push(c(a[i], b, j)) }
            ...
            var b = function(a, d, e) {
                ...
                for (var g, j, i = 0, o = e.length - 1; i < o; i++) {
                    ...
                    if (g) {
                        ...
                        f.splice(0, i + 1);
                        g = f.join(".");
                        if (h.isArray(d)) { j = 0; for (o = d.length; j < o; j++) f = {}, b(f, d[j], g), a[e[i]].push(f) } else a[e[i]] = d;
                        return
                    }
    ...
    var $a = function(a, b, c, d, e) {
            ...
            a = s.selector[a];
            if (a.length) { i = 0; for (o = a.length; i < o; i++) f = a[i](d, e, f) }
            return pa(f)
        },
        ab = function(a) {
            a || (a = {});
    ...
    m.defaults = {
        ...
        oClasses: {},
        oLanguage: {
            oAria: { sSortAscending: ": 升序", sSortDescending: ": 降序" },
            oPaginate: { sFirst: "第一页", sLast: "最后", sNext: "下一页", sPrevious: "上一页" },
            sEmptyTable: "No data available in table",
            sInfo: "显示从 _START_ 至 _END_ 记录，共 _TOTAL_ 条",
            sInfoEmpty: "显示从 0 至 0 记录，共 0 条",
        ...
        pageButton: {
            _: function(a, b, c, d, e, f) {
                var g = a.oClasses,
                    ...
                    p = function(b, d) {
                        ...
                        for (r = d.length; n < r; n++) {
                            ...
                            if (h.isArray(s)) {
                                ...
                                if (k !== null) {
                                    t = h("<a>", { "class": g.sPageButton + " " + l, "aria-controls": a.sTableId, "aria-label": i[s], "data-dt-idx": m, tabindex: a.iTabIndex, id: c === 0 && typeof s === "string" ? a.sTableId + "_" + s : null }).html(k).appendTo(b);
                                    Wa(t, { action: s }, v);
                                    m++
                                }
                            }
                    ...
                    r;
                try { r = h(b).find(H.activeElement).data("dt-idx") } catch (n) {}
                p(h(b).empty(), d);
